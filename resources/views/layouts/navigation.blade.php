        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->role === 'admin')
                    <span class="text-sm text-red-600 font-semibold">[ADMIN]</span>
                @else
                    <span class="text-sm text-green-600 font-semibold">[USER]</span>
                @endif
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        @if (Auth::user()->isAdmin())
                            <x-nav-link :href="route('news.index')" :active="request()->routeIs('admin.news.*')">
